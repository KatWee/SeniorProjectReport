...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0mm} % can define this in the preamble
  \setlength{\fboxsep}{0cm}
  \fbox{\includegraphics[width=10cm]{./image/ArchitectureDiagram.png}}
...
\begin{enumerate}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0mm} % can define this in the preamble
    \setlength{\fboxsep}{0cm}
    \fbox{\includegraphics[width=10cm]{./image/flowDiagram.png}}
...
\section{Mesos Cluster Setup}
    ...
    \setlength{\fboxrule}{0mm} % can define this in the preamble
    \setlength{\fboxsep}{0cm}
    \fbox{\includegraphics[width=6cm]{./image/cluster_setup.png}}
...
\section{Active Framework}
    ...
    \setlength{\fboxrule}{0mm} % can define this in the preamble
    \setlength{\fboxsep}{0cm}
    \fbox{\includegraphics[width=15cm]{./image/Framework.png}}
...
\section{Submit task}
    ...
    \setlength{\fboxrule}{0mm} % can define this in the preamble
    \setlength{\fboxsep}{0cm}
    \fbox{\includegraphics[width=15cm]{./image/submit.png}}
    \caption{Active Framework}\label{fig:submit}
    \end{figure}
